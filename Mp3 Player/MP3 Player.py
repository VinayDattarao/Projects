...
root = Tk()
root.title("Vinay Datta's Mini MP3 Player")
root.iconbitmap('C:/Code/music.ico')
...
back_btn_img = PhotoImage(file='C:/Code/back.png')
pause_btn_img = PhotoImage(file='C:/Code/pause.png')
play_btn_img = PhotoImage(file='C:/Code/play.png')
stop_btn_img = PhotoImage(file='C:/Code/stop.png')
forward_btn_img = PhotoImage(file='C:/Code/forward.png')
...
global vol3
global vol4
vol0 = PhotoImage(file='C:/Code/0.png')
vol1 = PhotoImage(file='C:/Code/0.png')
vol2 = PhotoImage(file='C:/Code/1.png')
vol3 = PhotoImage(file='C:/Code/2.png')
vol4 = PhotoImage(file='C:/Code/3.png')
